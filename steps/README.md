# Steps — what we do, what is done, what is next

One file per step. Each file has the same four parts: **Goal · Done · Doing · Next**. Update the step file in the same commit as the work.

| # | Step | File | State |
|---|---|---|---|
| 1 | Scaffold the project | `01_scaffold.md` | DONE |
...
Read order for a new chat: `00_INSTRUCTIONS.md` → `PROJECT.md` → the step file marked IN PROGRESS.
